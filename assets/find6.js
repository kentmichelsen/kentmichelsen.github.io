...
coolfind.create_find_div = function()
{
	...
	var button_style = "background-color:transparent !important;display: inline-block;  min-height: 1.15em; min-width: 1.5em; max-width: 2em; vertical-align: middle; text-align: center;"+ // Version 6.0b - Added font-size: 1em; for "button" element to display properly
		"border: 0px solid #fff; cursor: pointer; padding:0px; margin: 0px; -webkit-user-select:none; -ms-user-select: none;";
	var menu_style = "background-color:transparent !important; display: none;margin-right:-20px;";
	var input_style = "border: 0px solid #ccc;  display: inline; max-width: 55%;"; // Version 6.0b - changed width: 55% to max-width: 55%
	...
	if (typeof SVGRect == "undefined")
		...
		coolfind.find_button_html = '<svg width="1.15em" height="1.15em" viewbox="0 0 30 30">'+
			'<circle cx="18" cy="12" r="8" stroke="#ccc" stroke-width="2" fill="#fff" fill-opacity="0.4" />'+
...
coolfind.find_menu =  function(that)
{
	...
	if (that.nextElementSibling.style.display != "inline-block")
	{
		...
		that.innerHTML = "<span class='close_box'>&#215;</span>"; // Luk
		that.title = "Luk";
...
{		
	...
	if (el.currentStyle) // IE
	{
	    ...
	    pre.style.border = "1px solid #ccc"; // border not copying correctly in IE
	}
	else // webkit
	{
